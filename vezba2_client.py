...
try:
    while True:
        ...
        if what == 1:
            ...
            pozicija = input("Pozicija (vospituvach, gotvach, administrativec): ")
            if pozicija == 'vospituvach':
                grupa = input("Grupa: ")
            elif pozicija == 'gotvach':
                grupa = input('Grupa/Ekspertiza: ')
            else:
        ...
        if what == 8 and korime: #(sender, recepient)
            ...
            if proxy.isprati_do_korisnik(korime,recepient) != "Recepient not logged in \n" and proxy.isprati_do_korisnik(korime,recepient) != "First log in \n":
        ...
        if what == 9 and korime:    #(sender,ime)
            ime = input("Vnesi ime na grupa: ")
            poraka = input("Poraka: ")
            if proxy.isprati_do_grupa(korime,ime) != "You are not member of the group \n" and proxy.isprati_do_grupa(korime,ime) != "The group does not exist \n" and proxy.isprati_do_grupa(korime,ime) != "You have no permision or you are not logged in \n":
